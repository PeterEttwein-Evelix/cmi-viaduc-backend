...
namespace CMI.Web.Frontend.Helpers
{
    public class VeExportRecordHelper
    {
        ...
        public HttpResponseMessage CreateExcelFile(List<VeExportRecord> items, string language, string fileName = "Export")
        {
            ...
            {
                FileName = FrontendSettingsViaduc.Instance.GetTranslation("en", "veExportRecord.fileName") + $"_{ DateTime.Now.ToString("yyyy-MM-dd-hh_mm_ss")}.xlsx",
