...
namespace CMI.Access.Sql.Viaduc
{
    public class OrderDataAccess : DataAccess, IOrderDataAccess
    {
        ...
        private PrimaerdatenAufbereitungItem PrimaerdatenAufbereitungItemFromReader(SqlDataReader reader)
        {
            ...
            primaerdatenAufbereitungItem.OrderingDate = reader["OrderingDate"].GetValueOrNull<DateTime>(); // (DateTime?) reader["OrderingDate"];
            ...
            primaerdatenAufbereitungItem.GroesseInBytes = reader["GroesseInBytes"].GetValueOrNull<int>(); ;
