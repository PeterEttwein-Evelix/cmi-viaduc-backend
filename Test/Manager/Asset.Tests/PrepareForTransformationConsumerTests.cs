...
namespace CMI.Manager.Asset.Tests
{
    ...
    {
        private readonly Mock<IAssetManager> assetManager = new();
        private readonly Mock<IAssetPreparationEngine> preparationEngine = new();
        private readonly Mock<IScanProcessor> scanProcessorMock = new();
        private readonly Mock<ITransformEngine> transformEngineMock = new();
        private readonly Mock<IParameterHelper> parameterHelperMock = new();
        ...
        public async Task If_PrepareForTransformation_failed_Sync_process_is_set_to_failed()
        {
            try
            {
                ...
                var consumer = harness.Consumer(() => new PrepareForTransformationConsumer(assetManager.Object, scanProcessorMock.Object, transformEngineMock.Object, 
                    parameterHelperMock.Object, preparationEngine.Object));
                await harness.Start();
